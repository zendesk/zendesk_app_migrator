...
"use strict";
eval("\n\n/* global ZAFClient */\nvar client = ZAFClient.init();\n\nclient.on('app.registered', function (appData) {\n  var location = appData.context.location;\n  var App = __webpack_require__(\"./src/javascript/locations sync recursive ^\\\\.\\\\/.*\\\\.js$\")(\"./\" + location + '.js').default;\n  return new App(client, appData);\n});\n\n//# sourceURL=webpack:///./src/javascript/index.js?");

/***/ }),

/***/ "./src/javascript/lib/helpers.js":
/*!***************************************!*\
  !*** ./src/javascript/lib/helpers.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /**\n                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      *  Example ticket sidebar app\n                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      **/\n\nvar _i18n = __webpack_require__(/*! ../../javascript/lib/i18n */ \"./src/javascript/lib/i18n.js\");\n\nvar _i18n2 = _interopRequireDefault(_i18n);\n\nvar _helpers = __webpack_require__(/*! ../../javascript/lib/helpers */ \"./src/javascript/lib/helpers.js\");\n\nvar _default = __webpack_require__(/*! ../../templates/default */ \"./src/templates/default.js\");\n\nvar _default2 = _interopRequireDefault(_default);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar MAX_HEIGHT = 1000;\nvar API_ENDPOINTS = {\n  organizations: '/api/v2/organizations.json'\n};\n\nvar TicketSidebar = function () {\n  function TicketSidebar(client, appData, config) {\n    _classCallCheck(this, TicketSidebar);\n\n    this._client = client;\n    this._appData = appData;\n    this._config = config;\n\n    this._states = {};\n\n    this._initializePromise = this._init();\n  }\n\n  /**\n   * Initialize module, render main template\n   */\n\n\n  _createClass(TicketSidebar, [{\n    key: '_init',\n    value: function () {\n      var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        var currentUser, organizations;\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                _context.next = 2;\n                return this._client.get('currentUser');\n\n              case 2:\n                currentUser = _context.sent.currentUser;\n\n                this._states.currentUserName = currentUser.name;\n\n                _i18n2.default.loadTranslations(currentUser.locale);\n\n                _context.next = 7;\n                return this._client.request(API_ENDPOINTS.organizations).catch(this._handleError.bind(this));\n\n              case 7:\n                organizations = _context.sent;\n\n                if (!organizations) {\n                  _context.next = 12;\n                  break;\n                }\n\n                this._states.organizations = organizations.organizations;\n\n                // render application markup\n                (0, _helpers.render)('.loader', (0, _default2.default)(this._states));\n                return _context.abrupt('return', (0, _helpers.resizeContainer)(this._client, MAX_HEIGHT));\n\n              case 12:\n              case 'end':\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function _init() {\n        return _ref.apply(this, arguments);\n      }\n\n      return _init;\n    }()\n\n    /**\n     * Handle error\n     * @param {Object} error error object\n     */\n\n  }, {\n    key: '_handleError',\n    value: function _handleError(error) {\n      console.log('An error is handled here: ', error.message);\n    }\n  }]);\n\n  return TicketSidebar;\n}();\n\nexports.default = TicketSidebar;\n\n//# sourceURL=webpack:///./src/javascript/locations/ticket_sidebar.js?");
...
eval("module.exports = {\"name\":\"App Scaffold\",\"author\":{\"name\":\"Zendesk\",\"email\":\"support@zendesk.com\",\"url\":\"https://www.zendesk.com\"},\"defaultLocale\":\"en\",\"private\":true,\"location\":{\"support\":{\"ticket_sidebar\":\"assets/iframe.html\"},\"new_ticket_sidebar\":{\"url\":\"assets/iframe.html\"}},\"version\":\"1.0\",\"frameworkVersion\":\"2.0\"};\n\n//# sourceURL=webpack:///./src/manifest.json?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\n\nexports.default = function (args) {\n  return '<div class=\"example-app\">\\n    <div>\\n      <h1>Hi ' + (0, _helpers.escapeSpecialChars)(args.currentUserName) + ', this is a sample app</h1>\\n      <h2>' + _i18n2.default.t('default.example_string') + '</h2>\\n      <ul>' + (0, _helpers.templatingLoop)(args.organizations, organizationMarkup) + '</ul>\\n    </div>\\n  </div>';\n};\n\nvar _helpers = __webpack_require__(/*! ../javascript/lib/helpers.js */ \"./src/javascript/lib/helpers.js\");\n\nvar _i18n = __webpack_require__(/*! ../javascript/lib/i18n.js */ \"./src/javascript/lib/i18n.js\");\n\nvar _i18n2 = _interopRequireDefault(_i18n);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction organizationMarkup(organization) {\n  return '<li>' + (0, _helpers.escapeSpecialChars)(organization.name) + '</li>';\n}\n\n//# sourceURL=webpack:///./src/templates/default.js?");
...
eval("module.exports = {\"app.name\":\"example_app\",\"app.short_description\":\"Example\",\"app.long_description\":\"This is an example app using the app scaffold, following the learnings from migrating official apps\",\"app.installation_instructions\":\"The Example application has no specific settings and is ready to go.\",\"app.title\":\"Example\",\"default.example_string\":\"This is a sample translation\"}\n\n//# sourceURL=webpack:///./src/translations/en.json?");

/***/ }),

/***/ 0:
/*!**********************************************************************!*\
  !*** multi babel-polyfill ./src/javascript/index.js ./src/index.css ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\n__webpack_require__(/*! ./src/javascript/index.js */\"./src/javascript/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/index.css */\"./src/index.css\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/javascript/index.js_./src/index.css?");
